...
export default {
  ...
  computed: {
    ...mapGetters("getSocietyInfo", ["getSocietyInfo"]),
  ...
  methods: {
    ...mapActions("getSocietyInfo", ["getSociety"]),
  },
};
</script>
        ...
        <v-col cols="12" md="9">
          <v-row>
            ...
            <v-col
              ...
              sm="6"
              md="8"
              v-for="(getSocietyData, index) in getSocietyInfo.slice(0, 1)"
              :key="index"
            >
              <a :href="getSocietyData.url"
                ><div class="windowHover mx-auto my-md-6 my-4">
                  <div class="positionRelative">
                    <v-img
                      height="320"
                      class="hoverImage rounded"
                      :src="getSocietyData.urlToImage"
                    ></v-img>
                    <div class="positionAbsolute pa-2 rounded">
                      <div class="text-caption d-flex align-center white--text">
                        ...
                        >
                        {{ getSocietyData.publishedAt.slice(11, 16) }} /
                        {{ getSocietyData.publishedAt.slice(0, 10) }}
                      </div>
                      <div class="text-lg-subtitle-1 text-caption white--text">
                        <span v-html="getSocietyData.description"></span>
                      </div>
                    </div>
                  </div></div
              ></a>
            ...
            <v-col
              ...
              sm="6"
              md="4"
              v-for="(getSocietyData, index) in getSocietyInfo.slice(1, 51)"
              :key="index"
            >
              <a :href="getSocietyData.url">
                <div class="windowHover mx-auto my-md-6 my-4">
                  <div class="positionRelative">
                    ...
                    <div class="positionAbsolute pa-2 rounded">
                      ...
                      >
                        <span v-html="getSocietyData.description.slice(0, 80)"
                          >...</span
                        >
                      </div>
                      <div
