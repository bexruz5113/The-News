        ...
        <v-col cols="12" md="9">
          <v-row>
            ...
            <v-col
              ...
              sm="6"
              md="8"
              v-for="(getBusinessData, index) in getBusinessInfo.slice(0, 1)"
              :key="index"
            >
              <a :href="getBusinessData.url">
                <div class="windowHover mx-auto my-md-6 my-4">
                  <div class="positionRelative">
                    <v-img
                      height="320"
                      class="hoverImage rounded"
                      :src="getBusinessData.urlToImage"
                    ></v-img>
                    <div class="positionAbsolute pa-2 rounded">
                      <div class="text-caption d-flex align-center white--text">
                        ...
                        >
                        {{ getBusinessData.publishedAt.slice(11, 16) }} /
                        {{ getBusinessData.publishedAt.slice(0, 10) }}
                      </div>
                      <div class="text-lg-subtitle-1 text-caption white--text">
                        <span v-html="getBusinessData.description"></span>
                      </div>
                    </div>
                  </div></div
              ></a>
            ...
            <v-col
              ...
              sm="6"
              md="4"
              v-for="(getBusinessData, index) in getBusinessInfo.slice(1, 51)"
              :key="index"
            >
              <a :href="getBusinessData.url">
                <div class="windowHover mx-auto my-md-6 my-4">
                  <div class="positionRelative">
                    ...
                    <div class="positionAbsolute pa-2 rounded">
                      ...
                      >
                        <span v-html="getBusinessData.description.slice(0, 80)"
                          >...</span
                        >
                      </div>
                      <div
